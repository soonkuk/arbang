const DummyGameData = {
  '5d3034d631967e0030f068bf': {
    _id: '5d3034d631967e0030f068bf',
    title: 'Darts',
    genre: 'Sports',
    ...
    imageUri: 'https://via.placeholder.com/800x600.jpg?text=Darts(800x600)',
    thumbUri: 'https://via.placeholder.com/200x100.jpg?text=Darts+Thumb',
    gameUri: '/games/darts/index.html',
    popularity: 0,
  },
  '5d3034d631967e0030f068c0': {
    _id: '5d3034d631967e0030f068c0',
    title: 'Penalty Kicks',
    genre: 'Sports',
    ...
    imageUri: 'https://via.placeholder.com/800x600.jpg?text=Penalty+Kicks(800x600)',
    thumbUri: 'https://via.placeholder.com/200x140.jpg?text=Penalty+Kicks+Thumb',
    gameUri: '/games/panaltykicks/index.html',
    popularity: 0,
  },
  '5d3034d631967e0030f068c2': {
    _id: '5d3034d631967e0030f068c2',
    title: 'Jigsaw',
    genre: 'Puzzle',
    ...
    imageUri: 'https://via.placeholder.com/800x600.jpg?text=Jigsaw(800x600)',
    thumbUri: 'https://via.placeholder.com/200x140.jpg?text=Jigsaw+Thumb',
    gameUri: '/games/jigsaw/index.html',
    popularity: 0,
  },
  '5d3034d631967e0030f068c1': {
    _id: '5d3034d631967e0030f068c1',
    title: 'Master Chess',
    genre: 'Board',
    ...
    imageUri: 'https://via.placeholder.com/800x600.jpg?text=Master+Chess(800x600)',
    thumbUri: 'https://via.placeholder.com/200x140.jpg?text=Chess+Thumb',
    gameUri: '/games/masterchess/index.html',
    popularity: 0,
  },
  '5d3034d631967e0030f068c4': {
    _id: '5d3034d631967e0030f068c4',
    title: 'The Fruits',
    genre: 'Slotmachine',
    ...
    imageUri: 'https://via.placeholder.com/800x600.jpg?text=Fruits(800x600)',
    thumbUri: 'https://via.placeholder.com/200x140.jpg?text=Slot Machine',
    gameUri: '/games/thefruits/index.html',
    popularity: 0,
  },
  '5d3034d631967e0030f068c3': {
    _id: '5d3034d631967e0030f068c3',
    title: 'Sweety Memory',
    genre: 'Puzzle',
    ...
    imageUri: 'https://via.placeholder.com/800x600.jpg?text=Sweety+Memory(800x600)',
    thumbUri: 'https://via.placeholder.com/200x140.jpg?text=Sweet+Memory',
